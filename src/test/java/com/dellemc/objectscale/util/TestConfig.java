package com.dellemc.objectscale.util;
...
public class TestConfig {
     ...
     * @throws java.io.FileNotFoundException (wrapped) if the file was not found
     * @throws IOException                   (wrapped) if there was an error reading the file.
     */
    public static Properties getProperties(String projectName, boolean failIfMissing) {
        try {
