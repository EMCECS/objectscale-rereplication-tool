...
public class ReReplicationToolCli {
    ...
    static Options options() {
        ...
        options.addOption(Option.builder().longOpt("re-replicate-delete-markers")
                .desc("Re-replicate delete-markers that failed replication. WARNING: this will issue DELETE calls to objects, only if the file is a complete inventory (generated by the InventoryTool) and only for delete markers that are the latest version and whose replication status is FAILED")
                .build());
    ...
    static AbstractVersionScanningTool.Config parseConfig(CommandLine commandLine) {
        ...
        if (commandLine.hasOption("re-replicate")) {
            config = ReReplicationTool.Config.builder()
                    .reReplicateDeleteMarkers(commandLine.hasOption("re-replicate-delete-markers"))
